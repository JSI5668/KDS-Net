...
from datasets import VOCSegmentation, Cityscapes, cityscapes, Camvid, Camvid_Edge, Camvid_sample, Camvid_Edge_laplacian
...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='camvid_edge',
    ...
    parser.add_argument("--save_val_results_to",
                        default='E:/Second_paper/Result_Image/Edge/edge_result/Sobel_Secondfold',
                        help="save segmentation results to the specified dir")
    ...
    parser.add_argument("--ckpt",
        default='E:/Second_paper/Checkpoint/Camvid/EdgeNet_Secondfold/best_deeplabv3plus_resnet50_Edge_os16.pth',
        type=str,
